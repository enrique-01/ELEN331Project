...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "extendedKalmanFilter.autotvin.dat"
	set constFileTvOut       "extendedKalmanFilter.autotvout.dat"
	set constFileHdlTvIn     "extendedKalmanFilter.autohdltvin.dat"
	set constFileHdlTvOut    "extendedKalmanFilter.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
