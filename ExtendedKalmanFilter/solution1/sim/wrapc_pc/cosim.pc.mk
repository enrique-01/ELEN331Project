...
$(ObjDir)/tb_ExtendedKalmanFilter.cpp_pre.cpp.tb.o : tb_ExtendedKalmanFilter.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_ExtendedKalmanFilter.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/ExtendedKalmanFilter.cpp_pre.cpp.tb.o : ExtendedKalmanFilter.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ExtendedKalmanFilter.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
