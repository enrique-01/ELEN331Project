...
module extendedKalmanFilter_extendedKalmanFilter_Pipeline_VITIS_LOOP_67_75 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        p_reload58,
        p_reload57,
        mux_case_3165415_out,
        mux_case_3165415_out_ap_vld,
        mux_case_2164412_out,
        mux_case_2164412_out_ap_vld,
        mux_case_1163409_out,
        mux_case_1163409_out_ap_vld,
        mux_case_0162406_out,
        mux_case_0162406_out_ap_vld,
        P_2_0,
        P_2_0_ap_vld,
        P_2_1,
        P_2_1_ap_vld,
...
input  [63:0] p_reload60;
input  [63:0] p_reload59;
input  [63:0] p_reload58;
input  [63:0] p_reload57;
output  [63:0] mux_case_3165415_out;
output   mux_case_3165415_out_ap_vld;
output  [63:0] mux_case_2164412_out;
output   mux_case_2164412_out_ap_vld;
output  [63:0] mux_case_1163409_out;
output   mux_case_1163409_out_ap_vld;
output  [63:0] mux_case_0162406_out;
output   mux_case_0162406_out_ap_vld;
output  [63:0] P_2_0;
output   P_2_0_ap_vld;
output  [63:0] P_2_1;
output   P_2_1_ap_vld;
...
reg ap_idle;
reg mux_case_3165415_out_ap_vld;
reg mux_case_2164412_out_ap_vld;
reg mux_case_1163409_out_ap_vld;
reg mux_case_0162406_out_ap_vld;
reg P_2_0_ap_vld;
reg P_2_1_ap_vld;
reg P_2_2_ap_vld;
reg P_2_3_ap_vld;
...
wire   [63:0] tmp_4_fu_264_p6;
reg   [63:0] tmp_4_reg_426;
reg   [63:0] mul77_2_reg_431;
wire   [63:0] tmp_5_fu_277_p6;
reg   [63:0] tmp_5_reg_436;
reg   [63:0] add82_2_reg_441;
reg   [63:0] mul77_2_1_reg_446;
wire   [63:0] tmp_6_fu_290_p6;
reg   [63:0] tmp_6_reg_451;
reg   [63:0] add82_2_1_reg_456;
reg   [63:0] mul77_2_2_reg_461;
reg   [63:0] add82_2_2_reg_466;
reg   [63:0] mul77_2_3_reg_471;
reg   [63:0] add82_2_3_reg_476;
wire    ap_block_pp0_stage0;
reg   [2:0] j_fu_72;
wire   [2:0] add_ln67_fu_235_p2;
wire    ap_loop_init;
reg   [2:0] ap_sig_allocacmp_j_4;
reg   [63:0] mux_case_0162406_fu_76;
reg   [63:0] mux_case_1163409_fu_80;
reg   [63:0] mux_case_2164412_fu_84;
reg   [63:0] mux_case_3165415_fu_88;
...
#0 j_fu_72 = 3'd0;
#0 mux_case_0162406_fu_76 = 64'd0;
#0 mux_case_1163409_fu_80 = 64'd0;
#0 mux_case_2164412_fu_84 = 64'd0;
#0 mux_case_3165415_fu_88 = 64'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (*) begin
    if (((icmp_ln67_reg_410_pp0_iter66_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_0162406_out_ap_vld = 1'b1;
    end else begin
        mux_case_0162406_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_reg_410_pp0_iter66_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_1163409_out_ap_vld = 1'b1;
    end else begin
        mux_case_1163409_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_reg_410_pp0_iter66_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_2164412_out_ap_vld = 1'b1;
    end else begin
        mux_case_2164412_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_reg_410_pp0_iter66_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_3165415_out_ap_vld = 1'b1;
    end else begin
        mux_case_3165415_out_ap_vld = 1'b0;
    end
end
...
assign P_2_0 = add82_2_3_reg_476;

assign P_2_1 = add82_2_3_reg_476;

assign P_2_2 = add82_2_3_reg_476;

assign P_2_3 = add82_2_3_reg_476;

assign add_ln67_fu_235_p2 = (ap_sig_allocacmp_j_4 + 3'd1);
...
assign grp_fu_2030_p_din0 = mul77_2_reg_431;
...
assign grp_fu_2034_p_din0 = add82_2_reg_441;

assign grp_fu_2034_p_din1 = mul77_2_1_reg_446;

assign grp_fu_2034_p_opcode = 2'd0;

assign grp_fu_2038_p_ce = 1'b1;

assign grp_fu_2038_p_din0 = add82_2_1_reg_456;

assign grp_fu_2038_p_din1 = mul77_2_2_reg_461;

assign grp_fu_2038_p_opcode = 2'd0;

assign grp_fu_2042_p_ce = 1'b1;

assign grp_fu_2042_p_din0 = add82_2_2_reg_466;

assign grp_fu_2042_p_din1 = mul77_2_3_reg_471;

assign grp_fu_2042_p_opcode = 2'd0;

assign grp_fu_2050_p_ce = 1'b1;

assign grp_fu_2050_p_din0 = p_reload60;

assign grp_fu_2050_p_din1 = tmp_s_reg_421;

assign grp_fu_2054_p_ce = 1'b1;

assign grp_fu_2054_p_din0 = p_reload59;

assign grp_fu_2054_p_din1 = tmp_4_reg_426;

assign grp_fu_2074_p_ce = 1'b1;

assign grp_fu_2074_p_din0 = p_reload58;

assign grp_fu_2074_p_din1 = tmp_5_reg_436;

assign grp_fu_2078_p_ce = 1'b1;

assign grp_fu_2078_p_din0 = p_reload57;

assign grp_fu_2078_p_din1 = tmp_6_reg_451;

assign icmp_ln67_fu_229_p2 = ((ap_sig_allocacmp_j_4 == 3'd4) ? 1'b1 : 1'b0);

assign mux_case_0162406_out = mux_case_0162406_fu_76;

assign mux_case_1163409_out = mux_case_1163409_fu_80;

assign mux_case_2164412_out = mux_case_2164412_fu_84;

assign mux_case_3165415_out = mux_case_3165415_fu_88;

assign tmp_s_fu_245_p5 = ap_sig_allocacmp_j_4[1:0];

assign trunc_ln67_fu_241_p1 = ap_sig_allocacmp_j_4[1:0];

endmodule //extendedKalmanFilter_extendedKalmanFilter_Pipeline_VITIS_LOOP_67_75
