...
module extendedKalmanFilter_extendedKalmanFilter_Pipeline_VITIS_LOOP_121_2012 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        temp1_3_1_0384_out,
        temp1_3_1_0384_out_ap_vld,
        temp1_3_0_0383_out,
        temp1_3_0_0383_out_ap_vld,
        grp_fu_2094_p_din0,
        grp_fu_2094_p_din1,
        grp_fu_2094_p_dout0,
        grp_fu_2094_p_ce,
...
output  [63:0] temp1_3_1_0384_out;
output   temp1_3_1_0384_out_ap_vld;
output  [63:0] temp1_3_0_0383_out;
output   temp1_3_0_0383_out_ap_vld;
output  [63:0] grp_fu_2094_p_din0;
output  [63:0] grp_fu_2094_p_din1;
input  [63:0] grp_fu_2094_p_dout0;
output   grp_fu_2094_p_ce;
output  [63:0] grp_fu_2098_p_din0;
output  [63:0] grp_fu_2098_p_din1;
input  [63:0] grp_fu_2098_p_dout0;
output   grp_fu_2098_p_ce;

reg ap_idle;
reg temp1_3_1_0384_out_ap_vld;
reg temp1_3_0_0383_out_ap_vld;
...
wire   [63:0] select_ln124_1_fu_166_p3;
reg   [63:0] select_ln124_1_reg_266;
reg   [63:0] mul258_3_reg_271;
wire   [63:0] grp_fu_94_p2;
reg   [63:0] add263_3_reg_276;
reg   [63:0] mul258_3_1_reg_281;
wire   [63:0] grp_fu_99_p2;
reg   [63:0] add263_3_1_reg_286;
wire   [63:0] grp_fu_119_p2;
reg   [63:0] mul258_3_2_reg_291;
wire   [63:0] grp_fu_103_p2;
reg   [63:0] add263_3_2_reg_296;
wire   [63:0] grp_fu_124_p2;
reg   [63:0] mul258_3_3_reg_301;
wire   [63:0] grp_fu_107_p2;
reg   [63:0] temp1_0_reg_306;
reg   [1:0] j_fu_44;
wire   [1:0] add_ln121_fu_143_p2;
wire    ap_loop_init;
reg   [1:0] ap_sig_allocacmp_j_7;
wire    ap_block_pp0_stage0;
reg   [63:0] temp1_3_0_0383_fu_48;
wire   [63:0] temp1_1_2_fu_185_p3;
reg   [63:0] temp1_3_1_0384_fu_52;
wire   [63:0] temp1_1_1_fu_179_p3;
...
#0 j_fu_44 = 2'd0;
#0 temp1_3_0_0383_fu_48 = 64'd0;
#0 temp1_3_1_0384_fu_52 = 64'd0;
#0 ap_done_reg = 1'b0;
end
...
extendedKalmanFilter_dadd_64ns_64ns_64_13_full_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dadd_64ns_64ns_64_13_full_dsp_1_U373(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(mul258_3_reg_271),
    .din1(64'd0),
    .ce(1'b1),
    .dout(grp_fu_94_p2)
);
...
extendedKalmanFilter_dadd_64ns_64ns_64_13_full_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dadd_64ns_64ns_64_13_full_dsp_1_U374(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(add263_3_reg_276),
    .din1(mul258_3_1_reg_281),
    .ce(1'b1),
    .dout(grp_fu_99_p2)
);
...
extendedKalmanFilter_dadd_64ns_64ns_64_13_full_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dadd_64ns_64ns_64_13_full_dsp_1_U375(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(add263_3_1_reg_286),
    .din1(mul258_3_2_reg_291),
    .ce(1'b1),
    .dout(grp_fu_103_p2)
);
...
extendedKalmanFilter_dadd_64ns_64ns_64_13_full_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dadd_64ns_64ns_64_13_full_dsp_1_U376(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(add263_3_2_reg_296),
    .din1(mul258_3_3_reg_301),
    .ce(1'b1),
    .dout(grp_fu_107_p2)
);
...
extendedKalmanFilter_dmul_64ns_64ns_64_15_max_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_15_max_dsp_1_U379(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(mux_case_2168424_reload),
    .din1(64'd0),
    .ce(1'b1),
    .dout(grp_fu_119_p2)
);
...
extendedKalmanFilter_dmul_64ns_64ns_64_15_max_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_15_max_dsp_1_U380(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(mux_case_3169427_reload),
    .din1(64'd0),
    .ce(1'b1),
    .dout(grp_fu_124_p2)
);
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add263_3_1_reg_286 <= grp_fu_99_p2;
        add263_3_2_reg_296 <= grp_fu_103_p2;
        add263_3_reg_276 <= grp_fu_94_p2;
        ...
        mul258_3_1_reg_281 <= grp_fu_2098_p_dout0;
        mul258_3_2_reg_291 <= grp_fu_119_p2;
        mul258_3_3_reg_301 <= grp_fu_124_p2;
        mul258_3_reg_271 <= grp_fu_2094_p_dout0;
        select_ln124_1_reg_266[61 : 52] <= select_ln124_1_fu_166_p3[61 : 52];
        temp1_0_reg_306 <= grp_fu_107_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter68 == 1'b1))) begin
        temp1_3_0_0383_fu_48 <= temp1_1_2_fu_185_p3;
        temp1_3_1_0384_fu_52 <= temp1_1_1_fu_179_p3;
    end
end
...
always @ (*) begin
    if (((icmp_ln121_reg_250_pp0_iter66_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        temp1_3_0_0383_out_ap_vld = 1'b1;
    end else begin
        temp1_3_0_0383_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln121_reg_250_pp0_iter66_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        temp1_3_1_0384_out_ap_vld = 1'b1;
    end else begin
        temp1_3_1_0384_out_ap_vld = 1'b0;
    end
end
...
assign add_ln121_fu_143_p2 = (ap_sig_allocacmp_j_7 + 2'd1);
...
assign grp_fu_2094_p_din0 = mux_case_0166418_reload;

assign grp_fu_2094_p_din1 = select_ln124_reg_261;

assign grp_fu_2098_p_ce = 1'b1;

assign grp_fu_2098_p_din0 = mux_case_1167421_reload;

assign grp_fu_2098_p_din1 = select_ln124_1_reg_266;

assign icmp_ln121_fu_137_p2 = ((ap_sig_allocacmp_j_7 == 2'd2) ? 1'b1 : 1'b0);

assign select_ln124_1_fu_166_p3 = ((trunc_ln122_reg_254_pp0_iter12_reg[0:0] == 1'b1) ? 64'd4607182418800017408 : 64'd0);

assign select_ln124_fu_153_p3 = ((trunc_ln122_fu_149_p1[0:0] == 1'b1) ? 64'd0 : 64'd4607182418800017408);

assign temp1_1_1_fu_179_p3 = ((trunc_ln122_reg_254_pp0_iter67_reg[0:0] == 1'b1) ? temp1_0_reg_306 : temp1_3_1_0384_fu_52);

assign temp1_1_2_fu_185_p3 = ((trunc_ln122_reg_254_pp0_iter67_reg[0:0] == 1'b1) ? temp1_3_0_0383_fu_48 : temp1_0_reg_306);

assign temp1_3_0_0383_out = temp1_3_0_0383_fu_48;

assign temp1_3_1_0384_out = temp1_3_1_0384_fu_52;

assign trunc_ln122_fu_149_p1 = ap_sig_allocacmp_j_7[0:0];

always @ (posedge ap_clk) begin
    select_ln124_reg_261[51:0] <= 52'b0000000000000000000000000000000000000000000000000000;
    select_ln124_reg_261[63:62] <= 2'b00;
    select_ln124_1_reg_266[51:0] <= 52'b0000000000000000000000000000000000000000000000000000;
    select_ln124_1_reg_266[63:62] <= 2'b00;
end

endmodule //extendedKalmanFilter_extendedKalmanFilter_Pipeline_VITIS_LOOP_121_2012
