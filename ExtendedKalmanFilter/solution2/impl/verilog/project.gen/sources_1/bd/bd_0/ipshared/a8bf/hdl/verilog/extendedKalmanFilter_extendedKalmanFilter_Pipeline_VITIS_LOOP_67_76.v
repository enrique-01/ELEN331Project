...
module extendedKalmanFilter_extendedKalmanFilter_Pipeline_VITIS_LOOP_67_76 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        p_reload67,
        p_reload66,
        mux_case_3169427_out,
        mux_case_3169427_out_ap_vld,
        mux_case_2168424_out,
        mux_case_2168424_out_ap_vld,
        mux_case_1167421_out,
        mux_case_1167421_out_ap_vld,
        mux_case_0166418_out,
        mux_case_0166418_out_ap_vld,
        P_3_0,
        P_3_0_ap_vld,
        P_3_1,
        P_3_1_ap_vld,
...
input  [63:0] p_reload68;
input  [63:0] p_reload67;
input  [63:0] p_reload66;
output  [63:0] mux_case_3169427_out;
output   mux_case_3169427_out_ap_vld;
output  [63:0] mux_case_2168424_out;
output   mux_case_2168424_out_ap_vld;
output  [63:0] mux_case_1167421_out;
output   mux_case_1167421_out_ap_vld;
output  [63:0] mux_case_0166418_out;
output   mux_case_0166418_out_ap_vld;
output  [63:0] P_3_0;
output   P_3_0_ap_vld;
output  [63:0] P_3_1;
output   P_3_1_ap_vld;
...
reg ap_idle;
reg mux_case_3169427_out_ap_vld;
reg mux_case_2168424_out_ap_vld;
reg mux_case_1167421_out_ap_vld;
reg mux_case_0166418_out_ap_vld;
reg P_3_0_ap_vld;
reg P_3_1_ap_vld;
reg P_3_2_ap_vld;
reg P_3_3_ap_vld;
...
wire   [63:0] tmp_1_fu_264_p6;
reg   [63:0] tmp_1_reg_426;
reg   [63:0] mul77_3_reg_431;
wire   [63:0] tmp_2_fu_277_p6;
reg   [63:0] tmp_2_reg_436;
reg   [63:0] add82_3_reg_441;
reg   [63:0] mul77_3_1_reg_446;
wire   [63:0] tmp_3_fu_290_p6;
reg   [63:0] tmp_3_reg_451;
reg   [63:0] add82_3_1_reg_456;
reg   [63:0] mul77_3_2_reg_461;
reg   [63:0] add82_3_2_reg_466;
reg   [63:0] mul77_3_3_reg_471;
reg   [63:0] add82_3_3_reg_476;
wire    ap_block_pp0_stage0;
reg   [2:0] j_fu_72;
wire   [2:0] add_ln67_fu_235_p2;
wire    ap_loop_init;
reg   [2:0] ap_sig_allocacmp_j_3;
reg   [63:0] mux_case_0166418_fu_76;
reg   [63:0] mux_case_1167421_fu_80;
reg   [63:0] mux_case_2168424_fu_84;
reg   [63:0] mux_case_3169427_fu_88;
...
#0 j_fu_72 = 3'd0;
#0 mux_case_0166418_fu_76 = 64'd0;
#0 mux_case_1167421_fu_80 = 64'd0;
#0 mux_case_2168424_fu_84 = 64'd0;
#0 mux_case_3169427_fu_88 = 64'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (*) begin
    if (((icmp_ln67_reg_410_pp0_iter66_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_0166418_out_ap_vld = 1'b1;
    end else begin
        mux_case_0166418_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_reg_410_pp0_iter66_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_1167421_out_ap_vld = 1'b1;
    end else begin
        mux_case_1167421_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_reg_410_pp0_iter66_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_2168424_out_ap_vld = 1'b1;
    end else begin
        mux_case_2168424_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_reg_410_pp0_iter66_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_3169427_out_ap_vld = 1'b1;
    end else begin
        mux_case_3169427_out_ap_vld = 1'b0;
    end
end
...
assign P_3_0 = add82_3_3_reg_476;

assign P_3_1 = add82_3_3_reg_476;

assign P_3_2 = add82_3_3_reg_476;

assign P_3_3 = add82_3_3_reg_476;

assign add_ln67_fu_235_p2 = (ap_sig_allocacmp_j_3 + 3'd1);
...
assign grp_fu_1990_p_din0 = p_reload68;

assign grp_fu_1990_p_din1 = tmp_1_reg_426;

assign grp_fu_1994_p_ce = 1'b1;

assign grp_fu_1994_p_din0 = p_reload67;

assign grp_fu_1994_p_din1 = tmp_2_reg_436;

assign grp_fu_1998_p_ce = 1'b1;

assign grp_fu_1998_p_din0 = p_reload66;

assign grp_fu_1998_p_din1 = tmp_3_reg_451;

assign grp_fu_2058_p_ce = 1'b1;

assign grp_fu_2058_p_din0 = mul77_3_reg_431;

assign grp_fu_2058_p_din1 = 64'd0;

assign grp_fu_2058_p_opcode = 2'd0;

assign grp_fu_2062_p_ce = 1'b1;

assign grp_fu_2062_p_din0 = add82_3_reg_441;

assign grp_fu_2062_p_din1 = mul77_3_1_reg_446;

assign grp_fu_2062_p_opcode = 2'd0;

assign grp_fu_2066_p_ce = 1'b1;

assign grp_fu_2066_p_din0 = add82_3_1_reg_456;

assign grp_fu_2066_p_din1 = mul77_3_2_reg_461;

assign grp_fu_2066_p_opcode = 2'd0;

assign grp_fu_2070_p_ce = 1'b1;

assign grp_fu_2070_p_din0 = add82_3_2_reg_466;

assign grp_fu_2070_p_din1 = mul77_3_3_reg_471;

assign grp_fu_2070_p_opcode = 2'd0;

assign grp_fu_2082_p_ce = 1'b1;

assign grp_fu_2082_p_din0 = p_reload69;

assign grp_fu_2082_p_din1 = tmp_s_reg_421;

assign icmp_ln67_fu_229_p2 = ((ap_sig_allocacmp_j_3 == 3'd4) ? 1'b1 : 1'b0);

assign mux_case_0166418_out = mux_case_0166418_fu_76;

assign mux_case_1167421_out = mux_case_1167421_fu_80;

assign mux_case_2168424_out = mux_case_2168424_fu_84;

assign mux_case_3169427_out = mux_case_3169427_fu_88;

assign tmp_s_fu_245_p5 = ap_sig_allocacmp_j_3[1:0];

assign trunc_ln67_fu_241_p1 = ap_sig_allocacmp_j_3[1:0];

endmodule //extendedKalmanFilter_extendedKalmanFilter_Pipeline_VITIS_LOOP_67_76
