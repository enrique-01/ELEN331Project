...
module extendedKalmanFilter_extendedKalmanFilter_Pipeline_VITIS_LOOP_67_7 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        p_reload40,
        p_reload,
        mux_case_3157391_out,
        mux_case_3157391_out_ap_vld,
        mux_case_2156388_out,
        mux_case_2156388_out_ap_vld,
        mux_case_1155385_out,
        mux_case_1155385_out_ap_vld,
        mux_case_0154382_out,
        mux_case_0154382_out_ap_vld,
        P_0_0,
        P_0_0_ap_vld,
        P_0_1,
        P_0_1_ap_vld,
...
input  [63:0] p_reload42;
input  [63:0] p_reload41;
input  [63:0] p_reload40;
input  [63:0] p_reload;
output  [63:0] mux_case_3157391_out;
output   mux_case_3157391_out_ap_vld;
output  [63:0] mux_case_2156388_out;
output   mux_case_2156388_out_ap_vld;
output  [63:0] mux_case_1155385_out;
output   mux_case_1155385_out_ap_vld;
output  [63:0] mux_case_0154382_out;
output   mux_case_0154382_out_ap_vld;
output  [63:0] P_0_0;
output   P_0_0_ap_vld;
output  [63:0] P_0_1;
output   P_0_1_ap_vld;
...
reg ap_idle;
reg mux_case_3157391_out_ap_vld;
reg mux_case_2156388_out_ap_vld;
reg mux_case_1155385_out_ap_vld;
reg mux_case_0154382_out_ap_vld;
reg P_0_0_ap_vld;
reg P_0_1_ap_vld;
reg P_0_2_ap_vld;
reg P_0_3_ap_vld;
...
wire   [63:0] tmp_10_fu_264_p6;
reg   [63:0] tmp_10_reg_426;
reg   [63:0] mul_reg_431;
wire   [63:0] tmp_11_fu_277_p6;
reg   [63:0] tmp_11_reg_436;
reg   [63:0] add1_reg_441;
reg   [63:0] mul77_s_reg_446;
wire   [63:0] tmp_12_fu_290_p6;
reg   [63:0] tmp_12_reg_451;
reg   [63:0] add82_s_reg_456;
reg   [63:0] mul77_4_reg_461;
reg   [63:0] add82_4_reg_466;
reg   [63:0] mul77_5_reg_471;
reg   [63:0] add82_5_reg_476;
wire    ap_block_pp0_stage0;
reg   [2:0] j_4_fu_72;
wire   [2:0] add_ln67_fu_235_p2;
wire    ap_loop_init;
reg   [2:0] ap_sig_allocacmp_j;
reg   [63:0] mux_case_0154382_fu_76;
reg   [63:0] mux_case_1155385_fu_80;
reg   [63:0] mux_case_2156388_fu_84;
reg   [63:0] mux_case_3157391_fu_88;
...
#0 j_4_fu_72 = 3'd0;
#0 mux_case_0154382_fu_76 = 64'd0;
#0 mux_case_1155385_fu_80 = 64'd0;
#0 mux_case_2156388_fu_84 = 64'd0;
#0 mux_case_3157391_fu_88 = 64'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (*) begin
    if (((icmp_ln67_reg_410_pp0_iter66_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_0154382_out_ap_vld = 1'b1;
    end else begin
        mux_case_0154382_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_reg_410_pp0_iter66_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_1155385_out_ap_vld = 1'b1;
    end else begin
        mux_case_1155385_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_reg_410_pp0_iter66_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_2156388_out_ap_vld = 1'b1;
    end else begin
        mux_case_2156388_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln67_reg_410_pp0_iter66_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        mux_case_3157391_out_ap_vld = 1'b1;
    end else begin
        mux_case_3157391_out_ap_vld = 1'b0;
    end
end
...
assign P_0_0 = add82_5_reg_476;

assign P_0_1 = add82_5_reg_476;

assign P_0_2 = add82_5_reg_476;

assign P_0_3 = add82_5_reg_476;

assign add_ln67_fu_235_p2 = (ap_sig_allocacmp_j + 3'd1);
...
assign grp_fu_1974_p_din0 = mul_reg_431;

assign grp_fu_1974_p_din1 = 64'd0;

assign grp_fu_1974_p_opcode = 2'd0;

assign grp_fu_1978_p_ce = 1'b1;

assign grp_fu_1978_p_din0 = add1_reg_441;

assign grp_fu_1978_p_din1 = mul77_s_reg_446;

assign grp_fu_1978_p_opcode = 2'd0;

assign grp_fu_1982_p_ce = 1'b1;

assign grp_fu_1982_p_din0 = add82_s_reg_456;

assign grp_fu_1982_p_din1 = mul77_4_reg_461;

assign grp_fu_1982_p_opcode = 2'd0;

assign grp_fu_1986_p_ce = 1'b1;

assign grp_fu_1986_p_din0 = add82_4_reg_466;

assign grp_fu_1986_p_din1 = mul77_5_reg_471;

assign grp_fu_1986_p_opcode = 2'd0;

assign grp_fu_2086_p_ce = 1'b1;

assign grp_fu_2086_p_din0 = p_reload42;

assign grp_fu_2086_p_din1 = tmp_s_reg_421;

assign grp_fu_2090_p_ce = 1'b1;

assign grp_fu_2090_p_din0 = p_reload41;

assign grp_fu_2090_p_din1 = tmp_10_reg_426;

assign grp_fu_2094_p_ce = 1'b1;

assign grp_fu_2094_p_din0 = p_reload40;

assign grp_fu_2094_p_din1 = tmp_11_reg_436;

assign grp_fu_2098_p_ce = 1'b1;

assign grp_fu_2098_p_din0 = p_reload;

assign grp_fu_2098_p_din1 = tmp_12_reg_451;

assign icmp_ln67_fu_229_p2 = ((ap_sig_allocacmp_j == 3'd4) ? 1'b1 : 1'b0);

assign mux_case_0154382_out = mux_case_0154382_fu_76;

assign mux_case_1155385_out = mux_case_1155385_fu_80;

assign mux_case_2156388_out = mux_case_2156388_fu_84;

assign mux_case_3157391_out = mux_case_3157391_fu_88;

assign tmp_s_fu_245_p5 = ap_sig_allocacmp_j[1:0];

assign trunc_ln67_fu_241_p1 = ap_sig_allocacmp_j[1:0];

endmodule //extendedKalmanFilter_extendedKalmanFilter_Pipeline_VITIS_LOOP_67_7
